...
export const ClusterForm = (schema: any) => {
  ...
  const resource =
    ...
    "        value: " +
    '"' +
    form.watch("controller_flavor") +
    '"\n' +
    "      - name: worker_flavor" +
    "\n" +
    "        value: " +
    '"' +
    form.watch("worker_flavor") +
    '"\n' +
    "      - name: external_id" +
    "\n" +
    "        value: " +
    '"' +
    form.watch("external_id") +
    '"\n' +
    "    class: " +
    form.watch("clusterstack") +
    "\n" +
    "    controlPlane:\n" +
    "      replicas: " +
    form.watch("controlplane_replicas") +
    "\n" +
    "    version: v" +
    form.watch("kubernetes_version") +
    "\n" +
    "    workers:\n" +
    "      machineDeployments:\n" +
    "        - class: " +
                            ...
                            >
                              ...
                              <SelectContent>
                                <SelectGroup>
                                  ...
                                  <SelectItem value="SCS-1L-1">
                                    1 vCPU + 1GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-1L-1-5">
                                    1 vCPU + 1GiB RAM + 5GB Disk
                                  </SelectItem>
                                  <SelectItem value="SCS-1V-2">
                                    1 vCPU + 2GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-1V-2-5">
                                    1 vCPU + 2GiB RAM + 5GB Disk
                                  </SelectItem>
                                  <SelectItem value="SCS-1V-4">
                                    1 vCPU +4GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-1V-4-10">
                                    1 vCPU + 4GiB RAM + 10GB Disk
                                  </SelectItem>
                                  <SelectItem value="SCS-1V-8">
                                    1 vCPU + 8GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-1V-8-20">
                                    1 vCPU + 8GiB RAM + 20GB Disk
                                  </SelectItem>
                                </SelectGroup>
                                <SelectGroup>
                                  <SelectLabel>2 vCPU</SelectLabel>
                                  <SelectItem value="SCS-2V-4">
                                    2 vCPU + 4GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-2V-4-10">
                                    2 vCPU + 4GiB RAM + 10GB Disk
                                  </SelectItem>
                                  <SelectItem value="SCS-2V-4-20s">
                                    2 vCPU + 4GiB RAM + 20GB SSD
                                  </SelectItem>
                                  <SelectItem value="SCS-2V-8">
                                    2 vCPU + 8GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-2V-8-20">
                                    2 vCPU + 8GiB RAM + 20GB Disk
                                  </SelectItem>
                                  <SelectItem value="SCS-2V-16">
                                    2 vCPU + 16GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-2V-16-50">
                                    2 vCPU + 16GiB RAM + 50GB Disk
                                  </SelectItem>
                                </SelectGroup>
                                <SelectGroup>
                                  <SelectLabel>4 vCPU</SelectLabel>
                                  <SelectItem value="SCS-4V-8">
                                    4 vCPU + 8GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-4V-8-20">
                                    4 vCPU + 8GiB RAM + 20GB Disk
                                  </SelectItem>
                                  <SelectItem value="SCS-4V-16">
                                    4 vCPU + 16GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-4V-16-50">
                                    4 vCPU + 16GiB RAM + 50GB Disk
                                  </SelectItem>
                                  <SelectItem value="SCS-4V-16-100s">
                                    4 vCPU + 16GiB RAM + 100GB SSD
                                  </SelectItem>
                                  <SelectItem value="SCS-4V-32">
                                    4 vCPU + 32GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-4V-32-100">
                                    4 vCPU + 32GiB RAM + 100GB Disk
                                  </SelectItem>
                                </SelectGroup>
                                <SelectGroup>
                                  <SelectLabel>8 vCPU</SelectLabel>
                                  <SelectItem value="SCS-8V-32">
                                    8 vCPU + 32GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-8V-32-100">
                                    8 vCPU + 32GiB RAM + 100GB Disk
                                  </SelectItem>
                                  <SelectItem value="SCS-8V-16">
                                    8 vCPU + 16GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-8V-16-50">
                                    8 vCPU + 16GiB RAM + 50GB Disk
                                  </SelectItem>
                                </SelectGroup>
                                <SelectGroup>
                                  <SelectLabel>16 vCPU</SelectLabel>
                                  <SelectItem value="SCS-16V-32">
                                    16 vCPU + 32GiB RAM
                                  </SelectItem>
                                  <SelectItem value="SCS-16V-32-100">
                                    16 vCPU + 32GiB RAM + 100GB Disk
                                  </SelectItem>
                                </SelectGroup>
                              </SelectContent>
                            </Select>
